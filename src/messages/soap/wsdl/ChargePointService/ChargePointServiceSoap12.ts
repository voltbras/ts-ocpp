...
export interface IChargePointServiceSoap12Soap {
  ...
  ChangeAvailability: (
    ...
    cb: (
      err: any | null,
      result: IChangeAvailabilityOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  ChangeConfiguration: (
    ...
    cb: (
      err: any | null,
      result: IChangeConfigurationOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  RemoteStartTransaction: (
    ...
    cb: (
      err: any | null,
      result: IRemoteStartTransactionOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  RemoteStopTransaction: (
    ...
    cb: (
      err: any | null,
      result: IRemoteStopTransactionOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  CancelReservation: (
    ...
    cb: (
      err: any | null,
      result: ICancelReservationOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  GetConfiguration: (
    ...
    cb: (
      err: any | null,
      result: IGetConfigurationOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
  ...
  GetLocalListVersion: (
    ...
    cb: (
      err: any | null,
      result: IGetLocalListVersionOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any,
    options?: any,
